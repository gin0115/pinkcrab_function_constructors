...
typeSignatureEn: >
 Given any number of predicates on <code>T</code>, returns a function that yields the values of a <code>T</code>-iterable for which <em>at least one</em> predicate is true.

atGlance: >
 OR-combines multiple predicates into a single filter. Lazy — Generator in, Generator out, keys preserved.
